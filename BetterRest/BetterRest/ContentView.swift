...
struct ContentView: View {
        ...
        NavigationView {
            Form {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    DatePicker("Por favor selecione uma data", selection: $wakeUp, displayedComponents: .hourAndMinute)
                        .labelsHidden()
                }
                ...
                VStack(alignment: .leading, spacing: 0) {
                    Text("Quantidade de café ingerida")
                        .font(.headline)
    ...
    func calculateBedtime() {
        do {
            ...
            alertTitle = "Sua hora ideial de dormir é:"
